import {
  ...
  import NFTCard from "../components/NFTCardTwo";
  import {
  ...
  const Stake: NextPage = () => {
    ...
    const { contract, isLoading } = useContract(stakingContractAddressTwo);
    ...
    async function stakeNft(id: string) {
      ...
      if (!isApproved) {
        await nftDropContract?.setApprovalForAll(stakingContractAddressTwo, true);
      }
