import {
  ...
  import NFTCard from "../components/NFTCardThree";
  import {
  ...
  const Stake: NextPage = () => {
    ...
    const { contract, isLoading } = useContract(stakingContractAddressThree);
    ...
    async function stakeNft(id: string) {
      ...
      if (!isApproved) {
        await nftDropContract?.setApprovalForAll(stakingContractAddressThree, true);
      }
